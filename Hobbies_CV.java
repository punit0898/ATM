...
public class Hobbies_CV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        x3.setText("Provide details of each hobby or interest on your list .Tailor each hobby/activity ");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/jigsaw.png"))); // NOI18N
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try{
            ...
            stmt.executeUpdate("INSERT INTO `hobbies`(`UserId`, `HDescription`, `HRating`) VALUES ('"+userid+"','"+jTextField5.getText()+"','"+jTextField6.getText()+"');");
        }
        catch(Exception e)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hobbies_CV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
