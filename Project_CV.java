 ...
 * @author Mayank
 */
public class Project_CV extends javax.swing.JFrame {

    /**
     * Creates new form Project_CV
     */
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Name of the Project");
        ...
        jTextArea1.setText("Enter Your Project details.");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/project-management.png"))); // NOI18N
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try{
            ...
            stmt.executeUpdate("INSERT INTO `project`(`UserId`, `ProjectName`, `pYear`, `ProjectDiscription`) VALUES ('"+userid+"','"+jTextField5.getText()+"','"+Integer.parseInt(jTextField8.getText())+"','"+jTextArea1.getText()+"');");
        }
        catch(Exception e)
        {
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        Award_CV a=new Award_CV(userid);
        a.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Project_CV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Project_CV().setVisible(true);
            }
        });
    }
